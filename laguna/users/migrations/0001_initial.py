    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cellphone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
                ('nationality', users.models.CountryField(verbose_name='Country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fullAddress', models.CharField(max_length=1024, verbose_name='Full name')),
